...
export default class UserTerminalAccess extends Component {
    static navigationOptions = {
      title: 'UserTerminalAccess',
      headerStyle: {
    ...
    sendCardNumber() {
      ...
      fetch("http://192.168.18.135:9000/usersmngtAPI",{
        ...
        body: JSON.stringify({
          ...
          transactionType: 'TerminalAccess',
          inputType: 'Manual'
        }),
    ...
    render() {
      ...
      return (
        ...
        <View style={styles.container}>
          <Text style={{ fontSize: 32, paddingTop: 30, fontWeight: 'bold'}}> User Terminal Access</Text>
          <View>
...
<TouchableOpacity 
            ...
            <TouchableOpacity  
                onPress = { () => this.props.navigation.navigate('QRScanner', { qrType: 'TerminalAccess', transactionType: 'TerminalAccess', name: 'Ann', age: 28 })}>
